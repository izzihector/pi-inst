                ...
                switch (field.ks_data_comparison) {
                    ...
                    case "Ratio":
                        ...
                        if (count_1 && count_2) {
                            ...
                            item_info['count'] = self.ksNumFormatter(count_1 / gcd, 4) + ":" + self.ksNumFormatter(count_2 / gcd, 4);
                        } else {
                            item_info['count_tooltip'] = count_1 + ":" + count_2;
                            item_info['count'] = self.ksNumFormatter(count_1, 4) + ":" + self.ksNumFormatter(count_2, 4);
                        }
                        item_info['target_enable'] = false;
                        $kpi_preview = $(Qweb.render("ks_kpi_preview_template_2", item_info));
                        break;
