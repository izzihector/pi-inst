odoo.define('pivotino_user_guide.mark_as_lost_opportunity', function(require) {
    "use strict";
    ...
    tour.register('mark_as_lost_opportunity', {
        url: "/web",
        pivotino_tour: true,
        display_name: 'Mark as Lost Opportunity',
        ...
        trigger: ".o_lead_opportunity_form .btn.btn-primary:contains('Mark Lost')",
        content: _t("Click here to <b>create new quotation</b> from opportunity."),
        position: "bottom",
    }, {
        trigger: ".modal-body .o_input_dropdown",
        content: _t("Select <b>Lost Reason</b>."),
        position: "right",
    }, {
        trigger: ".modal-footer .btn.btn-primary[name='action_lost_reason_apply']",
        content: _t("Click here to <b>Submit Lost Reason</b>."),
        position: "bottom",
        edition: 'community',
    }]);
});
