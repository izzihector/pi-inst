odoo.define('pivotino_web_responsive.calendar', function (require) {
    "use strict";
    ...
    CalendarModel.include({
        /*
        * Inherit and change calendar configuration options
        */
        _getFullCalendarOptions: function () {
            var result = this._super.apply(this, arguments);
            result['weekNumbersWithinDays'] = false;
            result['weekNumberTitle'] = _t("W") + " ";
            return result
        },
    });
    ...
    CalendarRenderer.include({
        /*
        * Overrides to change the header format
        */
